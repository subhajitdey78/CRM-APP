...
exports.getAllTheatres = async (req, res) => {
    ...
    try {
        ...
        console.log("Get all failed bacause: ", e.message)
    }
}
...
exports.updateTheatre = async (req, res) => {
    ...
    if(!savedTheatre) {
        return res.status(400).send({
            message: "theatre being upadted deoesn't exist"
        });
    }

    savedTheatre.anme = req.body.name != undefined
    ...
    savedTheatre.city = req.body.city != undefined ? savedTheatre : savedTheatre.city;
    savedTheatre.pinCode = req.body.pinCode != undefined ? savedTheatre : savedTheatre.pinCode;
...
exports.deleteTheatre = async (req, res) => {
    try {
        ...
        res.status(200).send({
            message: "Successfull deleted theatre with id [ " + req.params.id + " ]" 
        });
    } catch (e) {
        console.log(e.message)
    }
