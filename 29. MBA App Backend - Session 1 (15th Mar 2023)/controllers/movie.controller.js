...
exports.createMovie = async (req, res) => {
    ...
    const movieObject = {
        ...
        realesStatus: req.body.realesStatus
    }

    try {
        const movie = Movie.create(movieObject);
...
exports.updateMovie = async (req, res) => {
    ...
    if(!savedMovie) {
        ...
        savedMovie.description = req.body.description != undefined ? req.body.decription : savedMovie.description
        ...
        savedMovie.releaseDate = req.body.releaseDate != undefined ? req.body.releaseStatus : savedMovie.releaseStatus
        savedMovie.releaseStatus = req.body.releaseDate != undefined ? req.body.releaseDate : savedMovie.releaseDate
